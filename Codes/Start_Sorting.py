...
class Sorting:
    def __init__(self, root, AlgoNameVar):
        ...
        # Algorithm Names
        self.algorithm = ['Selection Sort','Comb Sort','Cocktail Shaker Sort','Insertion Sort', 'Bubble Sort', 'Merge Sort', 'Quick Sort', 'Heap Sort',
                          'Shell Sort', 'Radix Sort','Gnome Sort']
        ...
        self.frame_radio = Frame(self.frame1, bg="#7fe7dc", width=230, height=25, relief="flat", bd=4)
        self.frame_radio.place(relx=0, rely=0.23)
        self.frame_radio.grid_propagate(0)
        # Creating the button / option
        self.bar_drawing = Radiobutton(self.frame_radio, text="Bar", bg="#7fe7dc", fg="navy", variable=self.graph_type, value=0,
                                       font=("Lucida Sans", 10, "bold"), command=self.draw_type, cursor="hand2")
        self.color_drawing = Radiobutton(self.frame_radio, text="Color", bg="#7fe7dc", fg="navy", variable=self.graph_type,
...
#         self.color_drawing.place(relx=0.5, rely=0)
        ...
        self.btn_sort = Button(self.frame_btn2, text="Sort", padx=13, pady=3, command=self.sort_list, bg="#5ED411", fg="azure", cursor="hand2")
        ...
        self.scale_size = Scale(self.frame1, label="Size :", orient=HORIZONTAL, from_=10, to=200, length=230,
                                bg="#ced7d8", troughcolor="#ECECEC", variable=self.size_var, command=self.change_size,
        ...
        self.scale_speed = Scale(self.frame1, label="Speed :", orient=HORIZONTAL, from_=1, to=500, length=230,
                                bg="#ced7d8", troughcolor="#ECECEC", variable=self.speed_var, command=self.change_speed, relief="solid", cursor="hand2")
        ...
        self.label_comparison = Label(self.frame1, text=" No. of comparisons: 0", bg="#7fe7dc", fg="midnight blue", font=("Lucida Sans", 12))
        ...
        self.label_avg = Label(self.frame_algo_info, bg="#D2FFFC", fg="midnight blue", text=self.information[self.algo_var.get()], font=("Lucida Sans", 13, "bold"))
        ...
        self.canva = Canvas(self.frame2, width=self.CANVAS_X, height=self.CANVAS_Y, bg="#ced7d8")
        self.canva.pack()
